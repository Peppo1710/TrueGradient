...
const Sidebar = ({ isCollapsed, onToggle }) => {
  ...
  return (
    <div className={`border-r shadow-outer border-gray-200 flex flex-col h-screen transition-all duration-300 ease-in-out flex-shrink-0 ${
        ...
        <div className="flex-1 divide-y divide-gray-200 overflow-hidden">
          <div className="p-6">
            ...
            <button 
              ...
              className="w-full bg-blue-500 hover:bg-blue-600 text-white rounded-2xl p-2 mb-4 flex items-center justify-center gap-2 transition-colors"
            >
          ...
          <div className="px-4 pb-4 flex-1 overflow-y-auto">
            {conversation.conversations.length === 0 ? (
              <div className="m-8 flex flex-col items-center justify-center h-full text-center">
                <div className=" ">
                  <MessageSquare className="lucide lucide-message-square h-8 w-8 mx-auto mb-2 opacity-70 text-gray-400" />
                </div>
